...
public class FollowService implements CommunityConstant {
    ...
    //Query whether the current user is concerned about changing entities
    ...
    //Querying a user's followers
    public List<Map<String, Object>> findFollowers(int userId, int offset, int limit) {
        String followerKey = RedisKeyUtil.getFollowerKey(ENTITY_TYPE_USER, userId);
        return getMaps(offset, limit, followerKey);
    }
    private List<Map<String, Object>> getMaps(int offset, int limit, String followeeKey) {
